...
public class ChosenProductPage extends BasePage{
    ...
    public static final By CHECKOUT_BUTTON = By.xpath("//*[@class='button-container']//*[@title='Оформить заказ']");
    public static final By CONTINUE_SHOPPING_BUTTON = By.xpath("//*[@class='button-container']//*[@title='Продолжить покупки']");
    ...
    public CartPage clickCheckoutButton(){
        Waiters.waitForElementLocated(driver,By.xpath("//*[@class='button-container']//*[@title='Оформить заказ']"), 5);
    ...
    public ChosenProductPage clickContinueShoppingButton(){
        Waiters.waitForElementLocated(driver,By.xpath("//*[@class='button-container']//*[@title='Продолжить покупки']"), 5);
